...
class MSRForm:
    ...
    def create(self):
        ...
        # Form title
        ttl = []
        ttl.append(Paragraph('Material Substitution Record', hd1))
        ...
        # second textarea box
        dscrp = []
        dscrp.append(Paragraph('Description of Deviation:', hd2))
        ...
        # final textarea box
        dscrp = []
        dscrp.append(Paragraph('Requested Substitution:', hd2))
